...
{
    /// <summary>
    /// Base class for logic flow exceptions.
    /// </summary>
    public abstract class BusinessLogicException : Exception
    {
        /// <summary>
        /// <c>true</c> if a unit of work should still commit its work when it encounters this exception.
        /// </summary>
        public bool TreatAsCommitSuccess { get; protected set; }

        /// <summary>
        /// Extra details that won't show up in the error message but could help with diagnostics.
        /// </summary>
        public IDictionary<string, object> LoggingProperties = new Dictionary<string, object>(); 

        /// <summary>
        /// Initializes a new instance of the <see cref="T:BusinessLogicException"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:BusinessLogicException"/> class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:BusinessLogicException"/> class with a specified error message and 
